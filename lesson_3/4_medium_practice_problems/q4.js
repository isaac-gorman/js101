...
A: Yes there is a difference. 
   concat() merges arrays, and does not mutate the existing array, but instead returns a new array
   push() adds elements to the end of an array and returns the new length of the array

   So with concat() you are actually using up new memory each time, and with push you are merely adding to the existing memory allocated for the array
